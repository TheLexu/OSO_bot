            ...
            if event.type == VkEventType.MESSAGE_NEW and event.to_me:
                ...
                if text in self.HELLO_WORDS:
                    ...
                    if answer == "Извините, я не понимаю вашего вопроса":
                        ...
                        keyboard.add_button('Задать другой вопрос', color=VkKeyboardColor.SECONDARY)
                        keyboard.add_button('Привет', color=VkKeyboardColor.NEGATIVE)

                        sender(
                            'Я не понял ваш вопрос. Попробуйте задать его по-другому или выберите одно из предложений.',
                            user_id=user_id,
